...
\begin{minipage}[t]{0.2\textwidth}
	...
	\rotatebox{90}{\icon{Github}{14}{\href{https://github.com/Samuel-Brown}{\scriptsize\textcolor{white}{\underline{Samuel-Brown}}}}}\includegraphics[width=3.1cm]{Samuel-Brown}
%faMortarBoard
\end{minipage}
